...
- download latest bz2 release
- curl -o /tmp/gmp-6.1.0.tar.bz2  https://gmplib.org/download/gmp/gmp-6.1.0.tar.bz2
- cd /tmp
...
-> that should work, if it doesn't ask google ;)


THEN
- go to the ext/string_hashing folder
- run:
> ruby extconf.rb
> make 
> make install

This will install the extension in your gemset 
